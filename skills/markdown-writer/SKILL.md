...
description: Use when creating, editing, or improving Markdown documents. Covers
  markdownlint compliance (MD001-MD048), professional writing style,
  document structure, README conventions, API documentation format,
  and technical guide patterns.
version: 0.1.0
metadata:
  author: adamancini
  repository: https://github.com/adamancini/opencode-skills
  tags: markdown,writer
  globs: ""
  alwaysApply: "true"
---
