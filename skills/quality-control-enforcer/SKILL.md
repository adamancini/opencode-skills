...
description: Use when reviewing implementations for quality, completeness, and
  correctness. Detects workarounds, simulated data, incomplete
  implementations, masked errors, and hard-coded logic that should be
  dynamic. Provides structured PASS/FAIL output with root cause analysis.
version: 0.1.0
metadata:
  author: adamancini
  repository: https://github.com/adamancini/opencode-skills
  tags: quality,control,enforcer
  globs: ""
  alwaysApply: "true"
---
...
5. **LLM-Driven Logic** - Flag hard-coded decision trees and conditional logic that should be AI-based instead.
