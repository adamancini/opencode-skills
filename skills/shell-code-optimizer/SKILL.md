...
description: Use when writing, reviewing, or improving shell scripts for bash and zsh.
  Covers cross-platform portability (Linux/macOS), built-in preference over
  external commands, shellcheck compliance, testability with shellspec, and
  POSIX compatibility patterns.
version: 0.1.0
metadata:
  author: adamancini
  repository: https://github.com/adamancini/opencode-skills
  tags: shell,code,optimizer
  globs: ""
  alwaysApply: "true"
---
